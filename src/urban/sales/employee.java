            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(c_search_tb, javax.swing.GroupLayout.PREFERRED_SIZE, 264, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(27, 27, 27)
...
// // initialize the save bnt:
 ...
 try{
     ...
     Statement s = null;
            ...
            int executeUpdate = s.executeUpdate(" INSERT INTO employee (name,tp) VALUES ('"+name+"','"+tp+"') ");
...
// initialize the search bnt:
    ...
    try{
    Statement s = (Statement) db.mycon().createStatement();
    ResultSet rs = s.executeQuery("SELECT * FROM employee WHERE id='"+csrch+"'");
...
// initialize the update bnt:
    ...
    try{
    Statement s = (Statement) db.mycon().createStatement();
    s.executeUpdate(" UPDATE employee SET name ='"+name+"', tp ='"+tp+"' WHERE id ='"+id+"' ");
